...
## ----fig.width=6, fig.height=6, out.width=600, out.height=600-----------------
require(phangorn)
...
## ----fig.width=14, fig.height=6, fig.show='hold', out.width=700, out.height=300----
require(phytools)
...
## ----message=FALSE, fig.width=6, fig.height=6, out.width=600, out.height=600----
require(ggplot2)
require(ggfortify)
require(cluster)
...
## ----message=FALSE, warning=FALSE, results='hide', fig.keep='all', fig.width=6, fig.height=6, out.width=600, out.height=600----
require(vegan)
